...
public interface IEstimate {
	 ...
	 * 修改：晁志平　FOR　V30
	 */
	public abstract void antiEstimate(EstimateVO VOs[], String cOperator)
	 ...
	 * 修改：晁志平 FOR  V30
	 */
	public abstract void estimate_yf(EstimateVO VOs[], ArrayList paraList,ClientLink cl)
			throws BusinessException;
	 ...
	 * @exception java.rmi.RemoteException 异常说明。
	 */
	public abstract EstimateVO[] queryEstimate_yf(String unitCode,
			ConditionVO conditionVO[], String sZG, String sEstPriceSource)
			throws BusinessException;
	 ...
	 * 修改：晁志平　FOR　V30
	 */
	public abstract void antiEstimate_yf(EstimateVO VOs[], String cOperator)
			throws BusinessException;

 ...
 * @author：左小军
 */
public class TrancustRefModel2 extends nc.ui.bd.ref.AbstractRefModel {
	private int m_DefaultFieldCount= 3;
	private String[] m_aryFieldCode= { "custcode", "custname", "bd_delivorg.vdoname", "bd_cumandoc.pk_cumandoc"  };//bd_cumandoc.pk_cumandoc
	...
	private String m_sPkFieldCode= "bd_cumandoc.pk_cumandoc";
	private String[] m_sHideFieldCode= {};
 ...
 * RouteRefModel 构造子注解。
 */
public TrancustRefModel2() {
	super();
  String part = "where bd_cumandoc.custflag in ('0','2') and dm_trancust.dr = 0 and bd_delivorg.vdoname = '销售【送货】及储运【调拨】业务' and bd_cumandoc.pk_corp = '"+ClientEnvironment.getInstance().getCorporation().getPk_corp() +"' " ;
	setWherePart( part );

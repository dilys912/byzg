 ...
 * @author：
 */
public class EstimateImpl implements IPuToIc_EstimateImpl,nc.itf.pu.inter.IPuToSc_EstimateBO, IEstimate,nc.bs.pub.para.IBeforSaveSysinit{
 ...
 * 修改：晁志平 FOR  V30
 */
public void estimate_yf(EstimateVO VOs[], ArrayList paraList,ClientLink cl)
	throws BusinessException {
	nc.vo.scm.pu.Timer timer = new nc.vo.scm.pu.Timer();
	timer.start();
      ...
      bodyVO[0].setVsourcebillcode(VOs[i].getVbillcode());
			...
			bodyVO[0].setNdrawsummny(d2);
			 ...
			 UFDouble nnumber = VOs[i].getNinnum()==null?new UFDouble(0):VOs[i].getNinnum();
			  bodyVO[0].setNmoney(nnumber.multiply(zgprice));
 ...
 * @exception java.rmi.RemoteException 异常说明。
 */
public EstimateVO[] queryEstimate_yf(String unitCode, ConditionVO conditionVO[], String sZG, String sEstPriceSource)
	throws BusinessException {
 ...
 * 修改：晁志平　FOR　V30
 */
public void antiEstimate_yf(EstimateVO VOs[], String cOperator)
	throws BusinessException {
	EstimateDMO dmo = null;
	ICreateCorpQueryService myService0 = null;
	boolean bLock = false;
		...
		for (int i = 0; i < VOs.length; i++) {
			...
			bodyVO[0].setYwybm(VOs[i].getCoperatorid());// 业务员
			 ...
			 UFDouble ntotalmoney = zgprice.multiply(nnumber);
				...
				// 税额
				bodyVO[0].setDfbbsj(new UFDouble(0));
				bodyVO[0].setDfybsj(new UFDouble(0));

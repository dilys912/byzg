...
public class saleEstimateVO extends CircularlyAccessibleValueObject
...
//  private UFDouble m_ninassistnum = null;
  ...
  public saleEstimateVO(String newCstockid)
  {
...
//        this.m_cmangid = ((String)value);
  ...
  {
    return new FieldDBValidateVO[] { new FieldDBValidateVO(NumField.class, new String[] { NCLangRes4VoTransl.getNCLangRes().getStrByID("common", "UC000-0002282") }, new UFDouble[] { this.m_noutnum }), new FieldDBValidateVO(PriceField.class, new String[] { NCLangRes4VoTransl.getNCLangRes().getStrByID("common", "UC000-0000741") }, new UFDouble[] { this.m_nprice }), new FieldDBValidateVO(MoneyField.class, new String[] { NCLangRes4VoTransl.getNCLangRes().getStrByID("common", "UC000-0004112") }, new UFDouble[] { this.m_nmoney }) };
  }

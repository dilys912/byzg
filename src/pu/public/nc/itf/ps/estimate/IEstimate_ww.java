...
public interface IEstimate_ww {
	 ...
	 */
	public abstract wwEstimateVO[] queryEstimate_ww(String unitCode,
	 ...
	 * 创建：王凯飞
	 */
	public abstract void estimate_ww(wwEstimateVO[] vOs, ArrayList paraList,ClientLink cl)
			throws BusinessException;
	 ...
	 * 作者：
	 */
	public abstract void antiEstimate_ww(wwEstimateVO[] vOs, String cOperator)
			throws BusinessException;
}
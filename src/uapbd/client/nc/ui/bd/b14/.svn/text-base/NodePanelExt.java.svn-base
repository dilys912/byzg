 ...
 * @author：祝奇
 */
public class NodePanelExt extends nc.ui.pub.beans.UIPanel {
	...
	/**
	 * add by yhj 2014-02-21
	 */
	private nc.ui.pub.beans.UITextField ivjMemoInput = null;
	private nc.ui.pub.beans.UILabel ivjMemoLabel = null;
/**
 * NodePanelExt 构造子注解。
 */
public NodePanelExt() {
 ...
 */
public NodePanelExt(java.awt.LayoutManager p0) {
	super(p0);
}
/**
 * NodePanelExt 构造子注解。
 ...
 * @param p1 boolean
 */
public NodePanelExt(java.awt.LayoutManager p0, boolean p1) {
	super(p0, p1);
}
/**
 * NodePanelExt 构造子注解。
 * @param p0 boolean
 */
public NodePanelExt(boolean p0) {
	super(p0);
}
/**
 * 此处插入方法说明。
...
public InvclVO getCurEditNode() throws Exception {
	...
	m_me.setMemo(this.getMemoInput().getText().trim());
 ...
 * add by yhj 2014-02-21
 */
private nc.ui.pub.beans.UITextField getMemoInput() {
	if (ivjMemoInput == null) {
		try {
			ivjMemoInput = new nc.ui.pub.beans.UITextField();
			ivjMemoInput.setBounds(137, 210, 244, 20);
			ivjMemoInput.setPreferredSize(new Dimension(246,20));
			ivjMemoInput.setMaxLength(40);
			ivjMemoInput.setMaxLength(240);
			ivjMemoInput.setSelectallWhenFocus(false);
		} catch (java.lang.Throwable ivjExc) {
			handleException(ivjExc);
		}
	}
...
private nc.ui.pub.beans.UILabel getMemoLabel() {
	if (ivjMemoLabel == null) {
		try {
			ivjMemoLabel = new nc.ui.pub.beans.UILabel();
			ivjMemoLabel.setName("memo");
			ivjMemoLabel.setText("备注");
			ivjMemoLabel.setLocation(30, 79);
			ivjMemoLabel.setILabelType(1);
		} catch (java.lang.Throwable ivjExc) {
			handleException(ivjExc);
		}
	}
...
//		setLayout(null);
		...
		//add by yhj 2014-02-21
		add(getMemoLabel(),getMemoLabel().getName());
		add(getMemoInput(),getMemoInput().getName());
	} catch (java.lang.Throwable ivjExc) {
		handleException(ivjExc);
	}
	// user code begin {2}
...
public static void main(java.lang.String[] args) {
	try {
		...
		NodePanelExt aNodePanel;
		aNodePanel = new NodePanelExt();
...
public void setNode(InvclVO parent, InvclVO me)
{
	...
	if (parent != null)
	{
		...
		getMemoInput().setText(parent.getMemo());
//		getForinvnameInput().setText(parent.getForinvname());
	...
	if (me != null)
	{
		...
		getMemoInput().setText(me.getMemo());
...
public void switchStatu(int statu)
{
	...
	if (statu == 0 || statu == 3) //浏览,删除
	{
		...
		getMemoInput().setEditable(false);

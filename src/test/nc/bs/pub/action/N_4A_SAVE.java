...
public class N_4A_SAVE extends AbstractCompiler2
{
...
private Throwable ex;
    ...
    throws BusinessException
  {
    try
    {
      ...
      if (!(inCurObject instanceof GeneralBillVO)) throw new BusinessException("Remote Call", new BusinessException("错误：您希望保存的库存其它入库类型不匹配"));
      if (inCurObject == null) throw new BusinessException("Remote Call", new BusinessException("错误：您希望保存的库存其它入库没有数据"));
      ...
      try
      {
        ...
        runClass("nc.bs.ic.pub.bill.MiscDMO", "fillBatchCode", "&INCURVO:nc.vo.pub.AggregatedValueObject", vo, this.m_keyHas, this.m_methodReturnHas);
        ...
        runClass("nc.bs.ic.pub.check.CheckBusiDMO", "checkRelativeBill", "&INCURVO:nc.vo.pub.AggregatedValueObject", vo, this.m_keyHas, this.m_methodReturnHas);
        ...
        runClass("nc.bs.ic.ic207.GeneralHDMO", "checkInNum", "&INCURVO:nc.vo.ic.pub.bill.GeneralBillVO,&INPREVO:nc.vo.ic.pub.bill.GeneralBillVO", vo, this.m_keyHas, this.m_methodReturnHas);
        ...
        retObj = runClass("nc.bs.ic.ic207.GeneralHBO", "saveBill", "&INCURVO:nc.vo.ic.pub.bill.GeneralBillVO,&INPREVO:Object", vo, this.m_keyHas, this.m_methodReturnHas);
        ...
        runClass("nc.bs.ic.ic207.GeneralHBO", "writeSpecialBill", "&INCURVO:nc.vo.ic.pub.bill.GeneralBillVO,&INPREVO:nc.vo.ic.pub.bill.GeneralBillVO", vo, this.m_keyHas, this.m_methodReturnHas);
        ...
        if ((retObj != null) && (!(retObj instanceof ArrayList))) throw new BusinessException("Remote Call", new BusinessException("错误：保存动作的返回值类型错误。"));
      }
      catch (Exception e)
      {
        setParameter("ERR", e.getMessage());
        setParameter("FUN", "保存");
        runClass("nc.bs.ic.pub.check.CheckBO", "insertBusinessExceptionlog", "&INCURVO:nc.vo.pub.AggregatedValueObject,&ERR:String,&FUN:String", vo, this.m_keyHas, this.m_methodReturnHas);

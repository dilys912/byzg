...
import nc.ui.mo.mo6600.IButton;
...
public class LpwsUI extends BillManageUI{
	...
	protected ManageEventHandler createEventHandler() {
		// TODO Auto-generated method stub
		return new LpwsHandler(this,new LpwsController());
	}
	...
	public void setDefaultData() throws Exception {
		...
		//在线隔离 批号生成规则：WS+年月日时分秒
		String time = "WS"+_getServerTime().getDate().toString().replace("-", "").concat(_getServerTime().getUFTime().toString().replace(":", ""));
...
//			getBillCardPanel().getHeadItem("nnumber").setValue(hgz.getNnumber());//数量
			getBillCardPanel().getHeadItem("nnumber").setValue("");//数量

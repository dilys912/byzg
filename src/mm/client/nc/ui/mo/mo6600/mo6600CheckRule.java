...
public class mo6600CheckRule extends BeforeActionCHK  implements ICheckRules,IUniqueRules,ICheckRules2{
	...
	public IUniqueRule[] getItemUniqueRules(String tablecode) {
		...
		if ("mm_glzb_b".equals(tablecode)) {
			unique = new IUniqueRule[] {
				new UniqueRule("下线隔离单子表表的 主表PK 不能重复！Downline isolated monad exemplar of the main table PK can not be repeated!", new String[] {  "pk_glzb"  })
			};
		}

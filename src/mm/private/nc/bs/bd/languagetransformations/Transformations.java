package nc.bs.bd.languagetransformations;
...
public class Transformations {
	...
	public static String getLstrFromMuiStr(String sourcestr)
	{
	 ...
	 {
		 if("null".equalsIgnoreCase(ClientEnvironment.getInstance().getLanguage())||"simpchn".equalsIgnoreCase(ClientEnvironment.getInstance().getLanguage()))
		 {
			 return sourcestr;
		 }
		 else 
